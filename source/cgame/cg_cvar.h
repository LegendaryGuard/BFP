...
CG_CVAR( cg_simpleHUD, "cg_simpleHUD", "0", CVAR_ARCHIVE ) // BFP - Simple HUD
...
CG_CVAR( cg_transformationAura, "cg_transformationAura", "1", CVAR_ARCHIVE ) // BFP - Transformation aura
