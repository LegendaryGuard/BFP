...
// BFP - NOTE: Some original BFP meansOfDeath aren't applied correctly like this replica does
...
DECLARE_MOD( MOD_KI_ATTACK ),		// BFP - Ki attack kill message
DECLARE_MOD( MOD_MELEE ),			// BFP - Melee
DECLARE_MOD( MOD_ILLEGAL_PLAYER_MODEL ),	// BFP - Illegal player model
