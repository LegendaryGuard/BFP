...
#define ARROWS_WIDTH		64
#define ARROWS_HEIGHT		128 // BFP - modified arrow height
...
static void Demos_MenuInit( void ) {
	...
	s_demos.list.generic.y			= (510-UI_MAX_ITEMS*SMALLCHAR_HEIGHT)/2;
